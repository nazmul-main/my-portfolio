        ...
        <div className="max-w-screen-xl mx-auto px-4 my-24 bg-[]">
            ...
            <div className="flex gap-12 justify-center items-center my-8">
                <div>
                    ...
                    <div className="w-24 bg-[#ebb080] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#a6d0e8] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#9fd4d4] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#d1bbed] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#77724b] rounded-full h-2.5 mb-4 ">
            ...
            <div className="flex gap-12 justify-center items-center">
                <div>
                    ...
                    <div className="w-24 bg-[#5f6d70] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#dbf8c1] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className=" w-24 bg-[#9ea2b1]  rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#8f8569] rounded-full h-2.5 mb-4 ">
                ...
                <div>
                    ...
                    <div className="w-24 bg-[#b0e3c5] rounded-full h-2.5 mb-4 ">
