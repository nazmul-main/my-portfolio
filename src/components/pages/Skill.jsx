            ...
            <div className="md:flex gap-12 justify-center items-center  my-8">
                <div>
                    <div className="mb-1 text-[#545352] font-medium ">
                        <img className="w-12 mx-auto" src="/public/htmk.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#0277BD] font-medium ">
                        <img className="w-12 mx-auto" src="/public/css.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#23BBBC] font-medium ">
                        <img className="w-12 mx-auto" src="/public/tailwind.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#A356FF] font-medium ">
                        <img className="w-12 mx-auto" src="/public/daisyui-removebg-preview.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#F0DB4F] font-medium ">
                        <img className="w-12 mx-auto" src="/public/Screjs.png" alt="" />
                    </div>
            ...
            <div className="md:flex gap-12 justify-center items-center ">
                <div>
                    <div className="mb-1 text-[#00D8FF] font-medium ">
                        <img className="w-12 mx-auto" src="/public/react-removebg-preview.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#81CD39] font-medium ">
                        <img className="w-12 mx-auto" src="/public/nodejs-removebg-preview.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#242938] font-medium ">
                        <img className="bg-[#9ea2b1] w-12 mx-auto" src="/public/expresss-removebg-preview.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#FFCB2D] font-medium ">
                        <img className="w-12 mx-auto" src="/public/firebase-removebg-preview.png" alt="" />
                    </div>
                ...
                <div>
                    <div className="mb-1 text-[#10AA50] font-medium ">
                        <img className="w-12 mx-auto" src="/public/mongodb-removebg-preview.png" alt="" />
                    </div>
